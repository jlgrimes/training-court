...
import { TournamentPlacement } from '@/components/tournaments/Placement/tournament-placement.types';
import { TournamentPlacementSelect } from '@/components/tournaments/Placement/TournamentPlacementSelect';
import { tournamentFormats, TournamentFormats } from '@/components/tournaments/Format/tournament-format.types';
      ...
      >
        <div className="p-4 sm:p-6">
          <DialogHeader className="pb-2">
            <DialogTitle>Create Pocket tournament</DialogTitle>
          </DialogHeader>
