...
export const EditableBattleLogPreview = (props: EditableBattleLogPreviewProps) => {
  ...
  return (
    <div className="relative flex items-center gap-2">
      ...
      <BattleLogEditButton isEditing={props.isEditing} log={props.battleLog} currentPlayer={(props.battleLog.players[0].name.toLowerCase() === userData?.live_screen_name?.toLowerCase()) ? props.battleLog.players[0] : props.battleLog.players[1]}
