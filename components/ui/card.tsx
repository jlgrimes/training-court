...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-1.5 pt-2 sm:pt-2 pb-2 sm:pb-3 px-4 sm:px-6", className)}
    {...props}
  />
))
CardHeader.displayName = "CardHeader"
...
export { Card, CardHeader, SmallCardHeader, CardFooter, CardTitle, CardDescription, CardContent }
