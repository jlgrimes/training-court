...
import { PlaymatBackground } from "@/components/landing/PlaymatBackground";
...
export function LandingPageContent() {
  ...
  return (
    <div className={cn("relative flex-1 w-full", uiRefresh && "overflow-hidden")}>
      {uiRefresh && <PlaymatBackground />}
      <div className="relative flex flex-col gap-24 items-center p-8 sm:p-12 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <TournamentRoundList
            ...
            updateClientRoundsOnEdit={async () => {}}
          />
          </div>
        </div>
        <div>
