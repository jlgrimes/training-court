...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
  ...
  const battleLog = parseBattleLog(logData.log, logData.id, logData.created_at || new Date().toISOString(), logData.archetype, logData.opp_archetype, null);
...
export default async function LiveLog({ params }: { params: { id: string } }) {
  ...
  const battleLog = parseBattleLog(logData.log, logData.id, logData.created_at || new Date().toISOString(), logData.archetype, logData.opp_archetype, userData?.live_screen_name ?? null);
